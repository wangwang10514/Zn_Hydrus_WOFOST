...
if __name__ == '__main__':
    ...
    for i in range(day_length):
        ...
        # 根系吸收后的最小锌含量需求
        # 还需要的锌需要通过转运方式获得
        ZDURT, ZDUST, ZDULF, ZDUER = calneed.cal_ZDU(j, blossom, ZDMIRT, ZDMIST, ZDMILF, ZDMIER, ZART1, ZAST1, ZALF1, ZAER1)
        ...
        TZDMX_list.append(TZDMX)
        TZDMI_list.append(TZDMI)
        TZA_list.append(SUMTZA)
